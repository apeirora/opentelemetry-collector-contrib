...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/scraper/zookeeperscraper v0.157.0
...
require (
	...
	go.opentelemetry.io/collector/scraper v0.157.1-0.20260723141305-52e6bf4aaaba // indirect
